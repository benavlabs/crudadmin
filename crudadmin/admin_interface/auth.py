...
from ..admin_user.schemas import AdminUserCreate, AdminUserUpdate, AdminUserUpdateInternal
from ..token.schemas import AdminTokenBlacklistCreate, AdminTokenBlacklistUpdate
...
class AdminAuthentication:
    ...
    async def get_current_superuser(self, current_user: Dict[str, Any]) -> Dict[str, Any]:
